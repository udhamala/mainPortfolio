...
function initMap() {
    "use strict";
    var uluru = {lat: 37.733795, lng: -122.446747},
...
//Variable declaration and assignment
	...
	if (fullname === "") { //Validation against empty field for fullname
		...
		//Show loading image
		$("#response_brought").html('<br clear="all"><div align="left" style=" padding-top:6px; margin-left:100px; margin-top:15px;"><font style="font-family:Verdana, Geneva, sans-serif; font-size:12px; color:black;">Please wait</font> <img src="img/loading.gif" alt="Loading...." align="absmiddle" title="Loading...."/></div>');
