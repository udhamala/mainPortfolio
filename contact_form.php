	...
	else
	{
			 ...
			 if(@mail($to_email, $email_subject, $message_body, $headers))
			 {
				//Displays the success message when email message is sent
				  echo "<br clear='all'><div align='left' class='form_success'>Congrats ".$from_fullname.", your email message has been sent successfully!<br>I will get back to you as soon as possible. Thanks.</div>";
			 } 
			 else 
			 {
